...
if (isset($_POST["calculateParallelogram"])) {
    ...
    $parallelogram = new Parallelogram("Parallelogram");
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-6">
                <div class="title" style="display: flex; justify-content: space-between; align-items: center;">
                    <h1>Form calculate <?php echo $name_class ?></h1>
                ...
                ?>
                    <form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="width" id="exampleInputEmail1" aria-describedby="emailHelp" required>
                        </div>
                ...
                ?>
                    <form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Width of Side</label>
                            <input type="number" class="form-control" name="side1" id="exampleInputEmail1" aria-describedby="emailHelp" required>
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Width of Side</label>
                            <input type="number" class="form-control" name="side2" id="exampleInputEmail1" aria-describedby="emailHelp" required>
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Width of Side</label>
                            <input type="number" class="form-control" name="side3" id="exampleInputEmail1" aria-describedby="emailHelp" required>
                        </div>
                ...
                ?>
                    <form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Height of Side</label>
                            <input type="number" class="form-control" name="height" id="exampleInputEmail1" aria-describedby="emailHelp" required>
                        </div>
                ...
                ?>
                    <form action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Side</label>
                            <input type="number" class="form-control" name="side" id="exampleInputEmail1" aria-describedby="emailHelp" required>
                        </div>
                        <div class="mb-3">
